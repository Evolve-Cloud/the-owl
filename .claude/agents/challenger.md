---
name: challenger
description: "Revisão adversarial (red-team): refutar planos, designs e decisões, achar furos e premissas frágeis ANTES de commitar. Use PROACTIVELY quando um plano/design/decisão precisa ser desafiado por um cético independente. NÃO use para segurança específica (sentinel), testes (guardian) nem rigor de conhecimento/fontes (curator)."
