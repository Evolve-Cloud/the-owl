---
name: scout
description: "Pesquisa de campo: investigar informação externa, coletar evidências, explorar território desconhecido e sintetizar achados. Use PROACTIVELY quando a tarefa exige PESQUISAR/DESCOBRIR (web, docs externas, prior art). NÃO use para busca só no código-base (use Explore) nem para design (architect)."
