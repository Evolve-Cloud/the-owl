...
description: "System design e infraestrutura em escala: sistemas distribuídos, escalabilidade, capacidade, confiabilidade, trade-offs de infra e dados em larga escala. Use PROACTIVELY quando o foco é escala, latência, throughput, capacity planning ou topologia de infra. NÃO use para design de aplicação (architect) nem requisitos (strategist)."
---
