---
name: team
description: "Orquestração paralela de múltiplos agentes especialistas para uma tarefa grande e decomponível. Use quando o usuário PEDIR EXPLICITAMENTE trabalho paralelo/fan-out de agentes, ou uma tarefa claramente se divide em subtarefas independentes de alto valor. Para tarefas normais, deixe o loop principal auto-delegar a UM especialista em vez de acionar o time."
---
