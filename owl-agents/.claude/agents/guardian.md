---
name: guardian
description: "Qualidade e testes: desenhar e verificar testes, cobertura, edge cases e portões de qualidade antes do merge. Use PROACTIVELY quando a tarefa é GARANTIR CORRETUDE via testes/verificação. NÃO use para segurança (sentinel) nem crítica adversarial de design (challenger)."
