---
name: strategist
description: "Planejamento de produto e requisitos: PRDs, épicos, histórias, roadmap, priorização, definição de escopo e sucesso. Use PROACTIVELY quando a tarefa é decidir O QUE construir e por quê (produto/requisitos), antes de qualquer design técnico. NÃO use para design técnico de arquitetura (architect) nem escala de infra (system-designer)."
---
