...
description: "Banco de dados e retrieval: modelagem de schema, queries, índices, performance de DB, migrations e pipelines de RAG/retrieval. Use PROACTIVELY quando a tarefa envolve schema, SQL, otimização de query ou recuperação de dados. NÃO use para código de aplicação genérico (builder)."
---
