---
name: builder
description: "Implementação de código de produção: escrever e editar features, refactors e correções seguindo o design existente. Use PROACTIVELY quando a tarefa é ESCREVER/ALTERAR código de aplicação. NÃO use para design (architect), banco de dados/retrieval (database-specialist), servidores MCP (mcp-builder) nem testes (guardian)."
---
